  ...
  return (
    <section className="py-16 bg-gray-100 text-gray-800">
      <div className="container mx-auto px-4">
        {/* Title */}
        <h2 className="text-4xl font-bold text-green-800 mb-8 text-center">Customer Support</h2>
        <p className="text-lg text-gray-600 text-center mb-12">
          We&apos;re here to help! Choose one of the options below or send us a message, and we&apos;ll get back to you as soon as possible.
        </p>
